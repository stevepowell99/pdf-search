...
p("Caveat: this tool may not find all text within the PDF, and sometimes it may mangle the text if it is laid out in columns."),
...
div(id="down","Upload finished") %>% hidden,
h3("Search"),
